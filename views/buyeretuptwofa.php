...
class UserSetupTwofa{
    ...
    function render(){
        ...
        $qrcodeimageURL= \TokenAuth6238::getBarCodeUrl($this->user->getUsername(), 'localhost', $this->user->getOTPsecretkey(), 'hrapp');
        ...
        echo '</br>';
        echo '<a href="http://localhost/hrapp/index.php?resource=user&action=login">Continue</a>';
