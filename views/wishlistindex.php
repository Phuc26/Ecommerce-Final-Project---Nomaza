    ...
    function render(...$data)
    {
        ...
        foreach ($wishlistData as $p) {
            ...
            $html .= "<tr>
                    ...
                    <td>
                    <a href='http://localhost/Ecommerce-Final-Project---Nomaza/index.php?resource=wishlist&action=delete&wishlistId=" . $p->wishlist_id . "'>Remove</a>
                    </td>
                    </tr>";
        }
